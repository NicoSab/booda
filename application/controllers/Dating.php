...
class Dating extends CI_Controller
{
	...
	public function results()
	{
        ...
        $config["uri_segment"] = 3;
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $data["results"] = $this->U_model->search($config["per_page"], $page, $hobbies, $job, $interest, $situation, $sexuality);
      	$config["total_rows"] = $this->U_model->count_search($hobbies, $job, $interest, $situation, $sexuality);
